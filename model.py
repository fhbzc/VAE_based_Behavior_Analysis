...
def get_default_hparams():
  ...
  hparams = tf.contrib.training.HParams(
      train_data_set="./data/train_dataset.npz",  # Our dataset.
      valid_data_set="./data/valid_dataset.npz",
      test_data_set="./data/test_dataset.npz",
      ...
      input_seq_len = 10, # the time steps used to train(10 means we use the first 10 steps as input to encode the strategy), we need to predict the last (max_seq_len - input_seq_len) steps
